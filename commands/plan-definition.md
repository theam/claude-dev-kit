...
5. **Handoff:** on approval, tell the PO the definition is ready and hand it to `/plan-backlog` (whose framing is then lighter). If they want it persisted, offer to save it as `docs/definitions/<slug>.md`. **Create no tickets here.**
